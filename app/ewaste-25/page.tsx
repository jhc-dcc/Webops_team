...
export default function EWasteDrive2026() {
  ...
  return (
    <div className="relative min-h-screen w-full max-w-[100vw] overflow-x-hidden bg-neutral-950 text-neutral-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-300">
      ...
      {/* Hero Section */}
      <section className="relative z-10 min-h-[50vh] flex items-center justify-center overflow-hidden border-b border-neutral-900">
        <div
                  ...
                  {mounted ? (
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        ...
                        <RechartsTooltip 
                          contentStyle={{ background: "#0a0a0a", borderColor: "#1f1f1f", borderRadius: "12px", fontSize: "11px", color: "#f5f5f5" }}
